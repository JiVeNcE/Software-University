    ...
    public class Battery
    {
        ...
        public string Type
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("Invalid value for type of Battery!");
                }
                this.type = value;
            }
        }
        ...
        public override string ToString()
        {
            ...
            if (this.Type != null)
            {
                batteryStr.AppendLine("Battery: " + this.Type);
            }
            if (this.Hours > 0)
            {
                batteryStr.AppendLine("Battery life:" + this.Hours + "hours");
            }
