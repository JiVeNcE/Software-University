function processEstatesAgencyCommands(commands) {
    ...
    Object.prototype.validateNonEmptyString = function(value, variableName){
        if (!value || typeof value != 'string') {
            throw new Error(variableName + 'should be non-empty strings')
        }
    };
    ...
    Object.prototype.validateInteger = function(value, variableName, minValue, maxValue){
    ...
    Object.prototype.validateBoolean = function(value, variableName){
        if ( typeof (value) != "boolean") {
            throw new Error(variableName + 'should be boolean values.')
        }
    };
    ...
    var Estate = (function() {
       ...
       function Estate(name, area, location, isFurnitured) {
        ...
        Estate.prototype.setArea = function (area) {
            this.validateInteger(area, 'Area', MIN_AREA, MAX_AREA );
            this._area = area;
        };
    ...
    var BuildingEstate = (function() {
        ...
        BuildingEstate.prototype.setRooms = function (rooms) {
            this.validateInteger(rooms, 'Rooms', MIN_ROOMS, MAX_ROOMS);
            this._rooms = rooms;
        };
    ...
    var House = (function() {
        ...
        House.prototype.setFloors = function (floors) {
           this.validateInteger(floors, 'floors', MIN_RLOORS, MAX_FLOORS);
            this._floors = floors;
        };
    ...
    var Garage = (function() {
        ...
        var MIN_WIDTHHEIGHT = 1;
        var MAX_WIDTHHEIGHT = 500;
        ...
        Garage.prototype.setWidth = function (width) {
           this.validateInteger(width, 'width', MIN_WIDTHHEIGHT, MAX_WIDTHHEIGHT);
            this._width = width;
        };
        ...
        Garage.prototype.setHeight = function (height) {
            this.validateInteger(height, 'height', MIN_WIDTHHEIGHT, MAX_WIDTHHEIGHT);
            this._height = height;
        };
    ...
    var Offer = (function() {
        ...
        Offer.prototype.setPrice = function (price) {
            this.validateInteger(price, 'price', MIN_PRICE, MAX_PRICE);
            this._price = price;
        };
    ...
    var EstatesEngine = (function() {
        ...
        function executeFindRentsByPriceCommand(minPrice, maxPrice) {
            Object.prototype.validateInteger(
                minPrice, "minPrice", Number.NEGATIVE_INFINITY, Number.POSITIVE_INFINITY);
            Object.prototype.validateInteger(maxPrice, "maxPrice",
        ...
        function executeFindSalesByLocationCommand(location) {
            return executeFindOffersByCommand(location, SaleOffer)
        }

        function executeFindRentsByLocationCommand(location) {
            return executeFindOffersByCommand(location, RentOffer)
        }

        function executeFindOffersByCommand(location, offerType) {
            if (!location) {
